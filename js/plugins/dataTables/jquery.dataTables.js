...
(/** @lends <global> */function( $ ) {
	...
	function _fnScrollingWidthAdjust ( settings, n )
	{
		...
		if ( scroll.sX || scroll.sY ) {
			...
			// so the table + scroll bar will fit into the areas available, otherwise
	...
	DataTable.defaults = {
		 ...
		 * a lot of data in a small areas (although paging and scrolling can both be
	 ...
	 *
	 * This namespace acts as a collection areas for plug-ins that can be used to
